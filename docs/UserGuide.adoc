...
* [example]#`add n/CS2103T Developer Guide p/10 d/2018-03-02`# : adds a task named `CS2103T Developer Guide` to the PrioriTask.
* [example]#`delete 3`# : deletes the 3rd task shown in the current list
* [example]#`exit`# : exits the application
...
* [example-code]#`add n/CS2103T Developer Guide p/9 d/2018-03-02 des/Write Introduction`#
* [example-code]#`add n/CS2101 Script p/8 d/2018-03-05 des/Script should be 500 words long t/CS2101`#
====
...
* [example-code]#`find Guide`# +
Returns `User Guide` and `Developer Guide`
* [example-code]#`f CS2101 Developer User`# +
...
* [example-code]#`findn Guide`# +
Returns `User Guide` and `Developer Guide`
* [example-code]#`fn CS2101 Developer User`# +
...
* [example-code]#`findd 2018-03-17`# +
Returns tasks with deadlines `2018-03-17`.
* [example-code]#`fd 2018-03-17 2018-09-04 2018-03-21`# +
...
* [example-code]#`list`# +
[example-code]#`delete 2`# +
Deletes the 2nd task in the PrioriTask.
* [example-code]#`find Developer`# +
[example-code]#`delete 1`# +
...
* [example-code]#`list`# +
[example-code]#`toggle 1`# +
Toggle the first task in the PrioriTask.
* [example-code]#`find homework`# +
[example-code]#`toggle 1`# +
...
* [example-code]#`delete 1`# +
[example-code]#`list`# +
[example-code]#`undo`# (reverses the `delete 1` command) +
...
* [example-code]#`delete 1`# +
[example-code]#`clear`# +
[example-code]#`undo`# (reverses the `clear` command) +
[example-code]#`undo`# (reverses the `delete 1` command) +
====
...
* [example-code]#`delete 1`# +
[example-code]#`undo`# (reverses the `delete 1` command) +
[example-code]#`redo`# (reapplies the `delete 1` command) +
...
[example-code]#`undo`# (reverses the `delete 1` command) +
[example-code]#`redo`# (reapplies the `delete 1` command) +
[example-code]#`redo`# (reapplies the `clear` command) +
====
...
* [example-code]#`adds 1 n/Submit report`# +
...
e.g. `delete 3`
* *Edit* : [format]#`edit INDEX [n/NAME] [p/PRIORITY_LEVEL] [d/DEADLINE] [des/DESCRIPTION] [t/TAG]…​`# +
e.g. `edit 1 p/9 d/2018-12-30`
* *Find* : [format]#`find KEYWORD [MORE_KEYWORDS]` or `f KEYWORD [MORE_KEYWORDS]`# +
e.g. `find CS2103 update 2018-03-17`
** *Find Name* : [format]#`findn KEYWORD [MORE_KEYWORDS]` or `fn KEYWORD [MORE_KEYWORDS]`# +
e.g. `findn Developer User`
** *Find Description* : [format]#`finddes KEYWORD [MORE_KEYWORDS]` or `fdes KEYWORDS [MORE_KEYWORDS]`# +
e.g. `finddes study update`
** *Find Deadline* : [format]#`findd KEYWORD [MORE_KEYWORDS]` or `fd KEYWORDS [MORE_KEYWORDS]`# +
e.g. `findd 2018-03-17 2018-09-07`
* *List* : [format]#`list`#
* *Help* : [format]#`help`#
* *Select* : [format]#`select INDEX`# +
e.g.`select 2`
* *Toggle* : [format]#`toggle INDEX`# +
e.g.`select 3`
...
=== Subtask Feature
* *Add Subtask* : [format]#`adds INDEX n/NAME`# +
