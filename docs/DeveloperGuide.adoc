...
|`* *` |user who is forgetful |have tasks' priority levels be automatically updated as the deadline approaches |transfer the responsibility of updating priority levels to the application

|`* *` |user who is forgetful |have a task's priority level be increased automatically if the task is still uncompleted after the deadline has passed |be reminded of uncompleted tasks
