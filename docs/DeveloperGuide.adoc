...
|`* * *` |user |add a task priority level |allow the App to order tasks by priority level

|`* * *` |user |add a task deadline |allow the application to manage the priority automatically

|`* * *` |user |delete a task |remove task that I no longer need
=======
>>>>>>> 7d122361a8f2579abf41a63d9d4248d07f50c61b
